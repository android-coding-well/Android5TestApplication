package com.gosuncn.test.widget.viewexplosion;
...
import com.gosuncn.test.widget.viewexplosion.factory.ParticleFactory;
...
public class ExplosionField extends View{
    ...
    AnimatorStatusInterface animatorStatusInterface;
    ...
    public void explode(final View view,Animator.AnimatorListener listener) {
        //防止重复点击
        if(explosionAnimatorsMap.get(view)!=null&&explosionAnimatorsMap.get(view).isStarted()){
            return;
        }
    ...
    private void explode(final View view,Rect rect) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                ...
                if(animatorStatusInterface!=null){
                    animatorStatusInterface.animStart(view,animation);
                }
            }
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                animation = null;
                if(animatorStatusInterface!=null){
                    animatorStatusInterface.animEnd(view,animation);
                }
            }
        });
        animator.start();
     ...
     * @param listener
     */
    public void addAnimatorListener(AnimatorStatusInterface listener){
        this.animatorStatusInterface=listener;
